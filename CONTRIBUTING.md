# Contributing to Token Price CLI

First off, thank you for considering contributing to Token Price CLI! It's people like you that make Token Price CLI such a great tool.
...
* `enhancement` - Issues for new features or non-critical improvements
